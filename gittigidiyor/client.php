...
class ggClient{
	 ...
	 */
	public function registerDeveloper($nick = null, $password = null,$lang=null) {
	 ...
	 */
	public function getCategories($startOffset=0 , $rowCount=4 , $withSpecs){
	 ...
	 */
	public function getCategory($categoryCode = null, $withSpec){
		//$withSpecs = $this->booleanConvert($withSpecs);
	...
	public function getRequiredCategorySpecs($categoryCode = null){
		return $this->clientConnect('anonymous','Category','getRequiredCategorySpecs',get_defined_vars());
	}
	...
	public function searchCatalog($page, $rowCount, $criteria){
		return $this->clientConnect('anonymous','Catalog','searchCatalog',get_defined_vars());
	}
...
public function updateProductWithNewCargoDetail($productId=null,$itemId=null, $product=null, $onSale=null, $forceToSpecEntry=null,  $nextDateOption=null){
...
public function updateVariantStock($productId=null,$itemId=null, $variantId=null,$stock=null){
	 ...
	 * @return Web Servis mesajini object olarak dondurur
	 */
	public function updateProductVariants( $productId = null,$itemId = null, $productVariant){
